...
def main():
    ...
    BLOCK_SIZE  = 131072             # at fs_dpd — 0.27 ms ≈ 7 OFDM symbols
    ...
    fig_s.tight_layout()
    fig_s.savefig('gmp_dpd_block_nr100_v2_convergence.png', dpi=150)
    print(f"\nStatic plot saved to gmp_dpd_block_nr100_v2_convergence.png")
    plt.close(fig_s)
    ...
    gif_file = 'gmp_dpd_block_nr100_v2_convergence.gif'
